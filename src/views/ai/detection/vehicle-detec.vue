  ...
  <div class="app-container">
    <div style="display: flex;">
      ...
      <div style="font-size: 20px; font-weight: bold; margin-left: 20px; margin-top: 40px;">
        车辆检测, 支持car、truck、bus、motorbike、tricycle、carplate
...
export default {
  ...
  data() {
    return {
      ...
      originFile: "",
      resultFile: "",
      uploadFileUrl: import.meta.env.VITE_API_URL + "/aidet/vehicleDetec", // 上传的图片服务器地址
      form: {
        imageFile: "",
        headers: {
        ...
        url:
          import.meta.env.VITE_API_URL + "/aidet/vehicleDetec",
      },
      //快捷生成
      content: {},
    };
